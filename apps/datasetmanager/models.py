...
class Dataset(models.Model):
    ...
    resource_issued = models.DateField(blank=True, null=True)
    # RP external_resource
    resource_id = models.IntegerField(blank=True, null=True)
    resource_publisher = models.CharField(max_length=100, blank=True, null=True)
    ...
    language_id = models.IntegerField(blank=True, null=True)  # RP languages
    ...
    subscription_id = models.CharField(max_length=800, null=True, blank=True, default='')
